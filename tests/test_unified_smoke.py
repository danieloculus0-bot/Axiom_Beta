...
def test_unified_smoke(tmp_path,monkeypatch):
    ...
    for route in ["/","/jobs","/purchase-orders","/inventory","/clocking-errors","/quality","/pm","/vault","/ez-fair","/methods","/ppap","/quoting","/planning","/suppliers","/integrations","/leadership","/automation","/reports","/payroll","/accounting","/sheets","/executive","/intelligence","/logic","/audit","/appearance","/health"]:
    ...
    assert "Executive Intelligence" in labels
